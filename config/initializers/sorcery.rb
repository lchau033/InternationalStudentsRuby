...
Rails.application.config.sorcery.configure do |config|
  ...
  #
   config.twitter.key = "cOMwUlZjM6n4a8DhaieQyhqmf"
   config.twitter.secret = "Ez21a2bqEHpExk3JvI16dHj2Sy24Ogp7ob3SnvJpa3C1jdejeL"
   config.twitter.callback_url = "https://navigating-canada-dev.herokuapp.com/oauth/callback?provider=twitter"
   config.twitter.user_info_mapping = {:email => "screen_name", :name => "screen_name"}
  #
   config.facebook.key = "1781873105445779"
   config.facebook.secret = "ed5412dc5b246a8a9d831124a74cb4e9"
   config.facebook.callback_url = "https://navigating-canada-dev.herokuapp.com/oauth/callback?provider=facebook"
